...
export default function Version3KineticTimeline() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // -------------------------------------------------------------
      // PHASE 1: Hero Stage -> 3D Rotating Card Carousel (00:00 - 00:03)
      // -------------------------------------------------------------
      // Hero elements recede/dissolve
      ...
      // 3D Perspective Project Cards rotate on Y axis across screen into focus
      tl.fromTo(carouselTrackRef.current,
        { x: "50%", scale: 0.85, opacity: 0, rotateY: 25 },
        { x: "-35%", scale: 1, opacity: 1, rotateY: -15, duration: 4, ease: "power2.out" },
        0.8
      );

      // -------------------------------------------------------------
      // PHASE 2: "Beyond every limit" + Sparkle Star (00:04 - 00:06)
      // -------------------------------------------------------------
      ...
      // -------------------------------------------------------------
      // PHASE 3: Curated Horizontal Work Showcase (00:06 - 00:09)
      // -------------------------------------------------------------
      // Statement dissolves
      ...
      // -------------------------------------------------------------
      // PHASE 4: Curved Purple Metallic CTA Stage + Kabish Portrait (00:09 - 00:16)
      // -------------------------------------------------------------
        ...
        >
          <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6 flex justify-center lg:justify-end">
              <div className="w-full max-w-md rounded-3xl bg-gradient-to-b from-white/[0.12] to-white/[0.03] border border-purple-500/30 p-6 backdrop-blur-2xl shadow-[0_20px_70px_rgba(76,29,149,0.35)] relative overflow-hidden">
                {/* Header status */}
